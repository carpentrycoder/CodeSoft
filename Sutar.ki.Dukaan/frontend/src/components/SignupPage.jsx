...
export default function SignupPage() {
  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center py-5 pt-4 bg-black z-0">
        <div className="bg-opacity-80 p-8 rounded-lg shadow-lg z-10 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
          ...
          <form className="space-y-4 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
            <div className="flex flex-wrap justify-between items-center ">
              ...
              <div className='w-1/3 bg-gradient-to-r from-indigo-500 to-purple-500 '>
                <label htmlFor="email" className="text-white block font-semibold mb-2 text-xl bg-gradient-to-r from-indigo-500 to-purple-500">Phone</label>
                <input type="email" id="email" className="w-full block-incline border-2 px-4 py-2 rounded bg-indigo-900 text-white" />
              </div>
              <div className='w-full bg-gradient-to-r from-indigo-500 to-pink-500'>
                <label htmlFor="password" className="text-white block font-semibold mb-2 text-xl bg-gradient-to-r from-indigo-500 to-pink-500">Password</label>
        ...
        <button className="bg-white text-black hover:bg-gray-100 border border-gray-300 py-2 mr-21 mt-5 px-4 absolute bottom-0 z-10 right-0 mb-20 mr-40 font-bold rounded-lg shadow" onClick={handleClick}>Back</button>
      </div> 
