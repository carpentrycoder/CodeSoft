  ...
  return (
    <section>
      <div className="bg-black text-white">
        <div className="container mx-auto flex flex-col md:flex-row items-center my-9 -mx-10 md:my-24">
          <div className="flex flex-col w-full lg:w-1/3 justify-center items-start p-6">
            ...
            <div className="flex flex-wrap">
              <button className="transition duration-700 ease-in-out bg-transparent hover:bg-yellow-300 text-yellow-300 font-bold hover:text-black rounded shadow hover:shadow-lg py-2 px-4 border-5 border-yellow-300 hover:bg-white mb-2 md:mr-2" onClick={handleLoginClick}>Login</button>
              <button className="transition duration-700 ease-in-out bg-transparent hover:bg-yellow-300 text-yellow-300 font-bold hover:text-black rounded shadow hover:shadow-lg py-2 px-4 border-5 border-yellow-300 hover:bg-white mb-2" onClick={handleSignupClick}>Signup</button>
            </div>
          </div>
